...
document.getElementById("generateAdaptiveBlock").onclick=generateAdaptiveTrainingBlock;
document.getElementById("applyAdaptiveBlock").onclick=applyAdaptiveTrainingBlock;
...
document.getElementById("raceDebriefSelect").onchange=renderRaceDebrief;
document.getElementById("saveRaceDebrief").onclick=saveRaceDebrief;
document.getElementById("refreshRaceDebrief").onclick=refreshRaceDebriefData;
